...
![image.png](https://raw.gitcode.com/user-images/assets/4769982/251aa1a0-f135-4083-a9e6-abf72cda06d6/image.png 'image.png')
...
3.  **南向适配层 (`ohos_adapter_ndk`)**：对 OpenHarmony 原生 NDK 和系统服务（例如网络、图形、输入和窗口管理）的调用的封装层
