...
#### Chromium扩展
基于原生Chromium在基础库，基础组件，多媒体，网络和渲染等方面进行了扩展。在基础库方面，新增性能监控特性，提供精确到 6 帧/12 帧/24 帧的微卡顿检测。在基础组件方面，重构了 Chromium 进程创建机制。在多媒体方面，支持HEIF/HEIC 硬件解码。在网络方面，支持IPv4/IPv6 并发连接和最优路径选择，提升网络的连接成功率，支持智能连接预加载机制，降低网络连接延迟。在渲染方面，新增同层渲染技术，支持ArkUI组件与Web DOM元素混合在一起进行排版渲染，保证ArkUI组件和DOM元素交互一致。
