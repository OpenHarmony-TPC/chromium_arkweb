...
class MockNWebDelegate : public NWebDelegateInterface {
 public:
  ...
  MOCK_METHOD(void, GetImageInfosByUrls, (const std::vector<std::string> &imageUrls,
                                          std::shared_ptr<NWebImageInfoCallback> callback), (override));
  MOCK_METHOD(void, GetImageInfosByXPaths, (const std::vector<std::string> &imageXPaths,
                                          std::shared_ptr<NWebImageInfoCallback> callback), (override));
#endif
  ...
  MOCK_METHOD(void,
              OnTouchMove,
              (const std::vector<std::shared_ptr<NWebTouchPointInfo>>&
                   touch_point_infos,
               bool from_overlay),
              (override));
  MOCK_METHOD(void,
  ...
  MOCK_METHOD(void,
              ...
              (override));
  MOCK_METHOD(int, Load, (const std::string& url), (override));
  ...
  MOCK_METHOD(bool,
              ...
              (const, override));
  MOCK_METHOD(void, OnBlur, (), (const, override));
  MOCK_METHOD(void,
              RegisterFindListener,
              (std::shared_ptr<NWebFindCallback> find_listener),
              (override));
  MOCK_METHOD(void, FindAllAsync, (const std::string& str), (const, override));
  MOCK_METHOD(void, ClearMatches, (), (const, override));
  MOCK_METHOD(void, FindNext, (const bool forward), (const, override));
  MOCK_METHOD(void, SuggestionSelected, (int index), (const, override));
  MOCK_METHOD(void,
  ...
  MOCK_METHOD(void,
              ...
              (override));
  MOCK_METHOD(void, StopFling, (), (override));
  ...
  MOCK_METHOD(void,
              ...
              (int tab_id, bool isWindowClosing, int windowId),
              (override));
  MOCK_METHOD(void,
  ...
  MOCK_METHOD(void, EnableMediaNetworkTrafficPrompt, (bool enable), (override));
  ...
  MOCK_METHOD(void,
              ...
              (const SafeBrowsingDetectionResult&),
              (override));
#endif
  ...
  MOCK_METHOD(void, Distill, (uint64_t request_id, const DistillOptions& distill_options,
