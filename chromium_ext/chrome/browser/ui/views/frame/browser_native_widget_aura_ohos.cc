...
BrowserNativeWidgetAuraOhos::BrowserNativeWidgetAuraOhos(
  ...
  if (delegate) {
    delegate->RegisterWidgetInitializedCallback(
        base::BindOnce(&BrowserNativeWidgetAuraOhos::OnWidgetInitialized,
                       base::Unretained(this)));
  }
}

BrowserNativeWidgetAuraOhos::~BrowserNativeWidgetAuraOhos() = default;

views::Widget::InitParams BrowserNativeWidgetAuraOhos::GetWidgetParams(
...
bool BrowserNativeWidgetAuraOhos::UseCustomFrame() const {
  return false;
}

void BrowserNativeWidgetAuraOhos::OnWidgetInitialized() {
...
BrowserNativeWidget* BrowserNativeWidgetFactory::Create(
    BrowserWidget* browser_widget,
    BrowserView* browser_view) {
  return new BrowserNativeWidgetAuraOhos(browser_widget, browser_view);
}
