...
public:
    static bool TestGetSystemMemoryInfo(base::SystemMemoryInfo* mem_info) {
...
void SystemMemoryPressureEvaluatorOhosFuzz003Test(const uint8_t* data, size_t size) {
    ...
    base::SystemMemoryInfo mem_info1;
    base::SystemMemoryInfo mem_info2;
    base::SystemMemoryInfo mem_info3;
