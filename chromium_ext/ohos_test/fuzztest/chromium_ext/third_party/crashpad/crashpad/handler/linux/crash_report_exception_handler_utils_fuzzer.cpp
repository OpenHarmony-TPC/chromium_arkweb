...
public:
    ...
    ssize_t ReadUpTo(crashpad::VMAddress address, size_t size, void* buffer) override {
        return 0;
    }
    ...
    bool ReadFileContentsAtOffset(const base::FilePath&, size_t, size_t, std::string*) { return true; }
    bool ReadMemory(uintptr_t, size_t, void*) { return true; }
    bool ReadRegisters(ThreadInfo*) { return true; }
    bool ReadThreadStack(pid_t, uintptr_t, size_t, std::string*) { return true; }
    bool WriteMemory(uintptr_t, size_t, const void*) { return true; }
    bool GetThreadName(pid_t, std::string*) { return true; }
    bool IsThreadAlive(pid_t) { return true; }
    bool GetProcessInfo(void*) { return true; }  // 简化处理
    bool ListThreads(std::vector<pid_t>*) { return true; }
    bool GetModuleInfoList(int, std::vector<int>*) { return true; }  // 简化处理
    bool GetProcessEnvironment(std::vector<std::string>*) { return true; }
    bool GetProcessArguments(std::vector<std::string>*) { return true; }
    bool GetProcessExecutable(base::FilePath*) { return true; }
    bool GetProcessWorkingDirectory(base::FilePath*) { return true; }
    bool GetThreadContexts(std::map<pid_t, void*>*) { return true; }  // 简化处理
    bool GetVmaList(std::vector<int>*) { return true; }  // 简化处理
    bool GetFdList(std::vector<int>*) { return true; }  // 简化处理
    bool GetFileOffset(uintptr_t, off_t*) { return true; }
    bool GetFileSize(const base::FilePath&, uint64_t*) { return true; }
    bool GetFileModificationTime(const base::FilePath&, base::Time*) { return true; }
    bool GetFilePermissions(const base::FilePath&, base::File::Info*) { return true; }
    bool GetFileExists(const base::FilePath&, bool*) { return true; }
    bool GetFileIsDirectory(const base::FilePath&, bool*) { return true; }
    bool GetFileIsRegularFile(const base::FilePath&, bool*) { return true; }
    bool GetFileIsSymbolicLink(const base::FilePath&, bool*) { return true; }
    bool GetFileReadable(const base::FilePath&, bool*) { return true; }
    bool GetFileWritable(const base::FilePath&, bool*) { return true; }
    bool GetFileExecutable(const base::FilePath&, bool*) { return true; }
    bool GetFileHidden(const base::FilePath&, bool*) { return true; }
    bool GetFileCreationTime(const base::FilePath&, base::Time*) { return true; }
    bool GetFileLastAccessTime(const base::FilePath&, base::Time*) { return true; }
    bool GetFileLastModifiedTime(const base::FilePath&, base::Time*) { return true; }
    ...
    bool GetFileSizeByMemoryMappedFile(const base::MemoryMappedFile&, uint64_t*) { return true; }
