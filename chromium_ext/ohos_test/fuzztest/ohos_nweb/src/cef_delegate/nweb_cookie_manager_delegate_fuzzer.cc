...
bool DoSomethingInterestingWithMyAPI(const uint8_t* data, size_t size) {
  ...
  nweb_cookie_manager_delegate.ReturnCookie(strData, false,
                                            nweb_string_value_callback);
  ...
  nweb_cookie_manager_delegate.ConfigCookie(strData, strData, false, false,
                                            nweb_long_value_callback);
  ...
  nweb_cookie_manager_delegate.SetCookie(strData, strData, true, false);
